...
// download func called by main func
void download(const char* url,int thread_amount,const char* file_name)
{
...
new_task:
    ...
    pthread_create(&monitor_id,NULL,monitor,(void *)res.file_name); // new pthread
...
int main (int ac, char * av[])
{
  ...
  if(ac<2){
        ...
        download(av[1],thread_amount,file_name); // 2 av input
